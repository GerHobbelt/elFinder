...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.REPLACE_WITH_xx_OR_xx_YY_LANG_CODE = {
		...
		messages   : {
			...
			'cmdsort'      : 'Sort',
			'cmdrights'		 : 'to manage rights',
			'cmdshare'     : 'share this file',
			...
			'aliasfor'        : 'Alias for',
			'locked'          : 'Locked',
			'doc_public'      : 'Public document',
			'make_public'     : 'You have need at least one tag, to make a public document',
			'dim'             : 'Dimensions',
			'files'           : 'Files',
			'folders'         : 'Folders',
			'items'           : 'Items',
			...
			'untitled folder' : 'untitled folder',
			'untitled file'   : 'untitled file.txt'
