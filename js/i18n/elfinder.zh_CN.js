...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.zh_CN = {
		...
		messages   : {
			...
			'errTrgFolderNotFound' : '目标文件夹 "$1" 不存在.',
			...
			'errUploadTotalSize'   : '数据超过了允许的最大值.',
			'errUploadFileSize'    : '文件超过了允许的最大值.',
			...
			'Sat'         : '周六',
			/******************************** sort variants ********************************/
			'sortnameDirsFirst' : '按名称 (文件夹最前)', 
			'sortkindDirsFirst' : '按类型 (文件夹最前)', 
			'sortsizeDirsFirst' : '按大小 (文件夹最前)', 
			'sortdateDirsFirst' : '按日期 (文件夹最前)', 
			'sortname'          : '按名称', 
			'sortkind'          : '按类型', 
			'sortsize'          : '按大小',
			'sortdate'          : '按日期',
