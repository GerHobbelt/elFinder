...
if (elFinder && elFinder.prototype && typeof(elFinder.prototype.i18) == 'object') {
	elFinder.prototype.i18.fr = {
		...
		messages   : {
			...
			'cmdrights'    : 'gérer les droits',
			'cmdshare'     : 'partager ce document',
			...
			'make_public'     : 'Vous avez besoin d\'au moins un mot clé, pour rendre votre document public',
			'dim'             : 'Dimensions',
			'files'           : 'Fichiers',
			'folders'         : 'Dossiers',
			'items'           : 'Éléments',
			...
			'untitled folder' : 'Nouveau Dossier',
			'untitled file'   : 'Nouveau Fichier.txt'
		}
	}
}
